...
__ONLP_DEFAULTI_IMPLEMENTATION(onlp_attributei_onie_info_get(onlp_oid_t oid, onlp_onie_info_t* rp));
__ONLP_DEFAULTI_IMPLEMENTATION(onlp_attributei_asset_info_get(onlp_oid_t oid, onlp_asset_info_t* rp));
